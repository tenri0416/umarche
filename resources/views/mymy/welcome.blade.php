...
<body class="antialiased">
    <div
        ...
        @if (Route::has('mymy.login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                @auth('mymys')
                    <a href="{{ url('/mymy/dashboard') }}"
                        class="text-sm text-gray-700 dark:text-gray-500 underline">Dashboard</a>
                @else
                    <a href="{{ route('mymy.login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Log
                        in</a>

                    @if (Route::has('mymy.register'))
                        <a href="{{ route('mymy.register') }}"
