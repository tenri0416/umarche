                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form id="delete_{{ $image->id }}" method="post"
                        ...
                        <div class=" p-2 w-full flex justify-around mt-32">
                            <a data-id="{{ $image->id }}" onclick="deletePost(this)"
                                class=" text-white bg-red-300 border-0 py-2 px-4 focus:outline-none hover:bg-red-500 rounded ">削除する</a>
                        </div>
                    </form>
                </div>
            </div>
