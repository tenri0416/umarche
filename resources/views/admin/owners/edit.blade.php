                                        ...
                                        <div class="p-2 w-1/2 mx-auto">
                                            <div class="relative">
                                                ...
                                                <input type="text" id="name" name="name"
                                                    ...
                                                    class="bg-gray-100
                                                    bg-opacity-50 rounded border border-gray-300 focus:border-blue-500
                                                    focus:bg-white focus:ring-2 focus:ring-blue-200 text-base
                                        ...
                                        <div class="p-2 w-1/2 mx-auto">
                                            <div class="relative">
                                                ...
                                                <input type="email" id="email"
                                                    name="email"value="{{ $owner->email }}" required
